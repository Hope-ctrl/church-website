...
const Footer = () => {
  return (
    <footer className="w-full bg-[#272323] border-t border-black px-6 py-10 lg:snap-start">
      <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 text-white">
